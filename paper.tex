...
\item[ii)] Reasoning behind the choice of arguments: if $H(Nin, \kid^{-1}("register\kid"))$ was used as an argument, then TODO. On the other hand, the choice of arguments $Nin$ and $\kid^{-1}("register\kid")$ would TODO.
\end{itemize}
\end{enumerate}
